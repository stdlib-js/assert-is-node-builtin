...
tape( 'the command-line interface tests if a string matches the name of a built-in Node.js module', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'fs\'; require( \''+fpath+'\' );"'
	];
